...
All the figures of the paper can be reproduced using the `plot_data.py` file, once you run the Learning.py script with all the needed parameters as mentioned in the table above.
If you do not have the results available in the Results directory, the `plot_data.py` script will return an error.
